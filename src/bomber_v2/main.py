    ...
    async def bomb_task(self):
        ...
        while self.running and not self.stop_event.is_set():
            ...
            try:
                ...
                # This helps in distributing requests more naturally and avoiding detection patterns.
                await asyncio.sleep(random.uniform(0.1, 0.8))
                await api()
            except Exception as e:
                logging.error(f"{R}[!] Task Exception: {e}{W}")

            # Post-request random delay: A longer, more significant delay after each request
            # This mimics human browsing behavior and helps in bypassing rate limits and anti-bot systems.
